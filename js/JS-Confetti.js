var JSConfetti = (function () {
    ...
    var h = (function () {
        function e(i) {
            ...
            var v = s(-150, 0),
                p = { x: n.x + ("left" === a ? -v : v) * this.absCos, y: n.y - v * this.absSin };
            ...
            i(e, [
                {
                    ...
                    value: function (t) {
                        ...
                        n
                            ? ((t.fillStyle = n), t.beginPath(), t.ellipse(e.x * h, e.y * h, i.x * h, i.y * h, o, 0, 2 * Math.PI), t.fill())
                            : s && ((t.font = "".concat(r, "px serif")), t.save(), t.translate(h * e.x, h * e.y), t.rotate(a), (t.textAlign = "center"), t.fillText(s, 0, 0), t.restore());
                    },
                },
                {
                    key: "updatePosition",
                    value: function (t, e) {
                        ...
                        i.x > s && (this.confettiSpeed.x -= n * t),
                            (this.currentPosition.x += i.x * ("left" === h ? -this.absCos : this.absCos) * t),
                            (this.currentPosition.y = this.initialPosition.y - i.y * this.absSin * c + (0.00125 * Math.pow(c, 2)) / 2),
                            (this.rotationSpeed -= this.emoji ? 1e-4 : 1e-5 * t),
                            this.rotationSpeed < 0 && (this.rotationSpeed = 0),
                            this.emoji
                                ? (this.emojiRotationAngle += (this.rotationSpeed * t) % (2 * Math.PI))
                                : "down" === o
                                ? ((this.radius.y -= t * a), this.radius.y <= 0 && ((this.radius.y = 0), (this.radiusYUpdateDirection = "up")))
                                : ((this.radius.y += t * a), this.radius.y >= this.initialRadius && ((this.radius.y = this.initialRadius), (this.radiusYUpdateDirection = "down")));
                    },
                },
                {
    ...
    function u(t) {
        var e = t.confettiRadius,
            ...
            l = void 0 === u ? 80 : u;
        return (
            t.emojies && console.error("emojies argument is deprecated, please use emojis instead"),
            t.confettiesNumber && console.error("confettiesNumber argument is deprecated, please use confettiNumber instead"),
            { confettiRadius: i, confettiNumber: s, confettiColors: r, emojis: c, emojiSize: l }
        );
    }
    var l = (function () {
        function e(i) {
            ...
            i(e, [
                {
                    ...
                    value: function () {
                        ...
                        (this.activeConfettiBatches = this.activeConfettiBatches.filter(function (t) {
                            return t.processShapes({ timeDelta: r, currentTime: a }, h, c), !c || !t.complete();
                        })),
                            this.iterationIndex++,
                ...
                },
                {
                    ...
                    value: function () {
                        for (
                            ...
                            var g = new h({ initialPosition: m, direction: "right", confettiRadius: i, confettiColors: s, confettiNumber: n, emojis: o, emojiSize: a, canvasWidth: c }),
                                C = new h({ initialPosition: v, direction: "left", confettiRadius: i, confettiColors: s, confettiNumber: n, emojis: o, emojiSize: a, canvasWidth: c });
                            p.addShapes(g, C);
                        }
